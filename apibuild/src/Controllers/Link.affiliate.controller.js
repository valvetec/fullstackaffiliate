...
const httpCreateLinkAffiliate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const checkLink = yield Link_affiliate_model_1.CreateLinkeAffiliate.findOne({ where: { affiliateOwnerId: user === null || user === void 0 ? void 0 : user.dataValues.id, productId: product === null || product === void 0 ? void 0 : product.dataValues.id } });
        if (checkLink) {
            const response = {
                id: checkLink === null || checkLink === void 0 ? void 0 : checkLink.dataValues.id,
                productId: checkLink === null || checkLink === void 0 ? void 0 : checkLink.dataValues.productId,
